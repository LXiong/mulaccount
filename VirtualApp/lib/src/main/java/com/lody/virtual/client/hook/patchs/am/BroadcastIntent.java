    ...
    private void handleInstallShortcutIntent(Intent intent) {
        ...
        if (shortcut != null) {
            ...
            if (component != null) {
                ...
                Intent newShortcutIntent = new Intent(Intent.ACTION_MAIN);
                ...
                //newShortcutIntent.setClassName(getHostPkg(),getHostPkg()+".enter.EnterActivity");
                newShortcutIntent.setComponent(new ComponentName(getHostPkg(), "io.virtualapp.enter.EnterActivity"));
                newShortcutIntent.addCategory(Intent.CATEGORY_LAUNCHER);
                newShortcutIntent.putExtra("pkg", pkg);
                newShortcutIntent.putExtra("duplicate", false);//设置是否重复创建
                /*newShortcutIntent.putExtra("_VA_|_intent_", shortcut);
                newShortcutIntent.putExtra("_VA_|_uri_", shortcut.toUri(0));
                newShortcutIntent.putExtra("_VA_|_user_id_", VUserHandle.myUserId());*/
                    ...
                    try {
                        ...
                        if (resources != null) {
                            ...
                            if (resId > 0) {
                                ...
                                Bitmap newIcon = BitmapUtils.drawableToBitMap(getHostContext().getResources(), iconDrawable);
                                if (newIcon != null) {
