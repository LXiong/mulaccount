...
public class PagerView extends ViewGroup implements PagerAdapter.OnDataChangeListener {
    ...
    private OnCreateShortListener onCreateShortListener;

    private OnEnterCreateShortListener onEnterCreateShortListener;
    ...
    public void removeView(View view) {
        ...
        int pages = (int) Math.ceil(getChildCount() * 1.0 / itemPerPage);
        LogUtils.d("rqy", "removeView--pages=" + pages + "--totalPage=" + totalPage);
        if (pages < totalPage) {
            if (this.onAddPageListener != null) {
    ...
    public void removeViewAt(int index) {
        ...
        int pages = (int) Math.ceil(getChildCount() * 1.0 / itemPerPage);
        LogUtils.d("rqy", "removeViewAt--pages=" + pages + "--totalPage=" + totalPage);
        if (pages < totalPage) {
            totalPage = pages;
            if (this.onAddPageListener != null)
                onAddPageListener.onAddOrDeletePage(totalPage, false);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (isCreateShortCut) {
                    if (onCreateShortListener != null) {
                        onCreateShortListener.onCreateShortListener(dragPosition);
                    }
    ...
    private View getView(int position) {
        ...
        if (mAdapter != null) {
            ...
            if (position % 2 == 0) {
                view.setBackgroundColor(Color.parseColor("#2b314b"));
            } else {
                view.setBackgroundColor(Color.parseColor("#282e48"));
            }
            AppModel item = (AppModel) mAdapter.getItem(position);
            view.setTag(item);
            if (item.isAd) {
                adViewList.add(view);
                return view;
 ...
 /*   public int getBottomPadding() {
    ...
    private void onDrag(int x, int y) {
        ...
        if (tempPosition != -1) {
            AppModel appModel = (AppModel) mAdapter.getItem(tempPosition);
            if (appModel.isAd) {
                return;
            }
        ...
        boolean isUnderBottomLine = y + dragBitmap.getHeight() + homeActivity.getCommentsLayoutWidth() > bottomLine;
        ...
        if (onEnterCrashListener != null) {
            onEnterCrashListener.enter(isRemoveApp);
        }

        if (onEnterCreateShortListener != null) {
            onEnterCreateShortListener.enter(isCreateShortCut);
        }
    ...
    public void setOnEnterCreateShortListener(OnEnterCreateShortListener onEnterCreateShortListener) {
        this.onEnterCreateShortListener = onEnterCreateShortListener;
    }
    ...
    public void setOnCreateShortListener(OnCreateShortListener onCreateShortListener) {
        this.onCreateShortListener = onCreateShortListener;
    }
 ...
 /*   public OnItemClickListener getOnItemClickListener() {
    ...
    public interface OnEnterCreateShortListener {
        void enter(boolean entered);
    }

    public interface OnCreateShortListener {
        void onCreateShortListener(int position);
    }
