...
public abstract class CardStackAdapter implements View.OnTouchListener, View.OnClickListener {
	...
	public CardStackAdapter(Context context) {
		...
		dp30 = (int) resources.getDimension(R.dimen.ivy_privacy_space_dp30);
		scaleFactorForElasticEffect = (int) resources.getDimension(R.dimen.ivy_privacy_space_dp8);
		dp8 = (int) resources.getDimension(R.dimen.ivy_privacy_space_dp8);
	}
	...
	void addView(final int position) {
		...
		root.setTag(R.id.ivy_privacy_space_cardstack_internal_position_tag, position);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		int positionOfCardToMove = (int) v.getTag(R.id.ivy_privacy_space_cardstack_internal_position_tag);
	...
	public void onClick(final View v) {
		...
		setScreenTouchable(false);
		if (mSelectedCardPosition == INVALID_CARD_POSITION) {
			mSelectedCardPosition = (int) v.getTag(R.id.ivy_privacy_space_cardstack_internal_position_tag);
