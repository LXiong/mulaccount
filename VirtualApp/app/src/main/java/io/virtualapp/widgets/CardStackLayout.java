 ...
 * <b>XML attributes</b>
 * <p>
 * See {@link R.styleable#ivy_privacy_space_CardStackLayout CardStackLayout Attributes}
 * <p>
 * {@link R.styleable#ivy_privacy_space_CardStackLayout_showInitAnimation}
 * {@link R.styleable#ivy_privacy_space_CardStackLayout_card_gap}
 * {@link R.styleable#ivy_privacy_space_CardStackLayout_card_gap_bottom}
 * {@link R.styleable#ivy_privacy_space_CardStackLayout_parallax_enabled}
 * {@link R.styleable#ivy_privacy_space_CardStackLayout_parallax_scale}
 */
public class CardStackLayout extends FrameLayout {
	...
	private void handleArgs(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
		...
		final TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ivy_privacy_space_CardStackLayout, defStyleAttr,
				defStyleRes);
		mParallaxEnabled = a.getBoolean(R.styleable.ivy_privacy_space_CardStackLayout_parallax_enabled, PARALLAX_ENABLED_DEFAULT);
		mShowInitAnimation = a.getBoolean(R.styleable.ivy_privacy_space_CardStackLayout_showInitAnimation, SHOW_INIT_ANIMATION_DEFAULT);
		mParallaxScale = a.getInteger(R.styleable.ivy_privacy_space_CardStackLayout_parallax_scale,
				getResources().getInteger(R.integer.ivy_privacy_space_parallax_scale_default));
		mCardGap = a.getDimension(R.styleable.ivy_privacy_space_CardStackLayout_card_gap, getResources().getDimension(R.dimen.ivy_privacy_space_card_gap));
		mCardGapBottom = a.getDimension(R.styleable.ivy_privacy_space_CardStackLayout_card_gap_bottom,
				getResources().getDimension(R.dimen.ivy_privacy_space_card_gap_bottom));
