...
import io.virtualapp.util.ListAppActivity;
...
public class HomePresenterImpl implements HomeContract.HomePresenter {
	...
	@Override
	public void dragNearCreateShortCut(boolean createShortCut) {
		if (createShortCut) {
			mView.setCreateShortCutShadow(true);
		} else {
			mView.setCreateShortCutShadow(false);
		}
	}
